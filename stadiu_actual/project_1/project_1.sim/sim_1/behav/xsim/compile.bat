...
REM
REM Generated by Vivado on Fri Apr 17 23:56:35 +0300 2026
...
echo "xvlog --incr --relax -prj tb_top_rom_vlog.prj"
call xvlog  --incr --relax -prj tb_top_rom_vlog.prj -log xvlog.log
